...
class Main(QMainWindow,MainUI):
    ...
    def Add_New_Book(self):
        ...
        self.db.commit()
        self.Show_All_Books()
        self.statusBar().showMessage('تمت اضافة الكتاب بنجاح')
    ...
    def Book_export_report(self):
        ...
        for row in data:
            ...
            row_num+=1
        excel_sheet.close()
        self.statusBar().showMessage('تم  عمل التفرير بنجاح ')
    ...
    def Add_Employee(self):
        ...
        if password == password2 :
            ...
            self.statusBar().showMessage('تم الموظف العميل بنجاح')
        else:
    ...
    def Edit_empolyee_Date(self):
        ...
        self.db.commit()
        self.statusBar().showMessage('تم تعديل بينات الموظف بنجاح')
